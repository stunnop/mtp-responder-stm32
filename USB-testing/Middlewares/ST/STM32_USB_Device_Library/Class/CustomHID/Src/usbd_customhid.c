...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgFSDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x03,         /*bNumEndpoints*/
  0x06,         /*bInterfaceClass: CUSTOM_HID*/
  ...
  MTP_EP_BULKIN_SIZE, /*wMaxPacketSize: 2 Byte max */
  0x00,
  ...
  0x02, /* bmAttributes: Bulk endpoint */
  MTP_EP_BULKOUT_SIZE,  /* wMaxPacketSize: 2 Bytes max  */
  0x00,
  0x00,  /* bInterval: Polling Interval */
  /* 41 */
  ...
  0x07,          /* bLength: Endpoint Descriptor size */
	USB_DESC_TYPE_ENDPOINT, /* bDescriptorType: */
	MTP_EP_INTR_ADDR,  /*bEndpointAddress: Endpoint Address (IN)*/
